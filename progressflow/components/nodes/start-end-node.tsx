...
const StartEndNode = ({ data, isConnectable, selected }: NodeProps) => {
  ...
  return (
    <div className="relative" ref={nodeRef}>
      <div
        className={`shadow-md bg-white border-2 border-gray-300 rounded-full min-w-[120px] h-[60px] flex items-center justify-center ${
