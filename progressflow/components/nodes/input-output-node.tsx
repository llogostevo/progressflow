...
const InputOutputNode = ({ data, isConnectable, selected }: NodeProps) => {
  ...
  useEffect(() => {
    setLabel(data.label || "Input/Output")
  }, [data.label])
  ...
  return (
    <div className="relative" ref={nodeRef}>
      <div
        className="shadow-md bg-white border-2 border-gray-300 min-w-[120px] h-[60px] flex items-center justify-center transform skew-x-12"
        onClick={handleClick}
      >
      ...
      <Handle
        ...
        style={{ transform: "translateX(0) skewX(0deg)" }}
      />
      <Handle
        type="source"
